            ...
            <div className='music_received_main'>
                ...
                <section className="receivedMusic_section_1 music_RightSideBar">
                    ...
                    <div className="gosple_main">
                        ...
                        <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/5v0nHekCRbODpHtDgPnAwX?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
                    </div>
                </section>
            </div>
         );
