...
class LandingPageDrinks extends Component {
  ...
  componentDidMount() {
   ...
   .then(response => {
     ...
     // Update the component state with the image URL and drink name
     this.setState({ imageUrl, drinkName });
   })
  ...
  render() {
    ...
    const { drinks, currentPage, itemsPerPage, imageUrl, drinkName } = this.state;
